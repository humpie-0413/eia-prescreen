...
# Protected routers (JWT 임시 해제 — 테스트용)
app.include_router(screening_router, prefix="/api/screening", tags=["screening"])
app.include_router(evaluation_router, prefix="/api/screening", tags=["evaluation"])
app.include_router(cases_router, prefix="/api/cases", tags=["cases"])
app.include_router(cases_screening_router, prefix="/api/screening", tags=["cases"])
app.include_router(compare_router, prefix="/api/screening", tags=["compare"])
app.include_router(draft_router, prefix="/api/screening", tags=["draft"])
app.include_router(review_router, prefix="/api/screening", tags=["review"])
